...
def scaled_dot_product_attention(query, keys, values):
    ...
    Args:
        query (torch.Tensor): Query tensor of shape (batch_size, query_length, d_model).
        keys (torch.Tensor): Key tensor of shape (batch_size, key_length, d_model).
        values (torch.Tensor): Value tensor of shape (batch_size, key_length, d_model).
        
    Returns:
        torch.Tensor: Scaled dot-product attention output tensor of shape (batch_size, query_length, d_model).
    """
...
keys = torch.randn(batch_size, key_length, d_model)
values = torch.randn(batch_size, key_length, d_model)
print("query: ", query)
print("keys:  ", keys)
print("values:", values)
